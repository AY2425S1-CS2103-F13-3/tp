...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Meeting")]),_v(": A user-defined event that includes information such as a name, date, time, and associated contacts. Can be edited, added, or deleted.")]),_v(" "),_c('li',[_c('strong',[_v("Schedule")]),_v(": A collection of events (meetings) associated with a user’s contacts. The schedule can be viewed, modified, and checked for conflicts.")]),_v(" "),_c('li',[_c('strong',[_v("Contact")]),_v(": An individual or entity that is linked to a schedule. Contacts can be added or removed from schedules via commands.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case:")]),_v(" "),_c('ol',[_c('li',[_v("Expected:")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 6 Nov 2024, 14:19:15 GMT+8]")])])])}
}];
